...
function validation(){
	...
	if(desc === ""){
		errors += '<p>Informe Seu Produto</p>';
	}
	if(amount === ""){
		errors += '<p>Informe a Quantidade</p>';
	}else if(amount != parseInt(amount)){
		errors += '<p>Informe a Quantidade Valida</p>';
	}
	if(value === ""){
		errors += '<p>Informe um Valor</p>';
	...
	if(errors != ""){
		...
		document.getElementById("errors").innerHTML = "<h3>Por Favor:</h3>" + errors;
		return 0;
	}else{
		return 1;
	}
